(() => {
   ...
   window.addEventListener("load", function (e) {
      oe(),
         document.querySelector(".top__slider") &&
         new re(".top__slider", {
            modules: [ae],
            observer: !0,
            observeParents: !0,
            ...
            breakpoints: {
               ...
               1150: { slidesPerView: 1, spaceBetween: 30 },
            },
            on: {},
         }),
         document.querySelector(".now__slider") &&
         new re(".now__slider", {
            modules: [ae],
            observer: !0,
            observeParents: !0,
            ...
            loop: !0,
            breakpoints: {
               320: { slidesPerView: 1.145, spaceBetween: 25 },
               768: { slidesPerView: 2.15, spaceBetween: 30 },
               992: { slidesPerView: 3, spaceBetween: 31 },
            },
            on: {},
         }),
         document.querySelector(".collection-slider__slider") &&
         new re(".collection-slider__slider", {
            modules: [ae],
            observer: !0,
            observeParents: !0,
            slidesPerView: 3,
            ...
            loop: !0,
            breakpoints: {
               320: { slidesPerView: 1.15, spaceBetween: 25 },
               768: { slidesPerView: 2.15, spaceBetween: 30 },
               992: { slidesPerView: 3, spaceBetween: 35.3 },
            },
            on: {},
         });
   });
   ...
   const de = document.querySelector(".spoller"),
      ce = document.querySelectorAll(".collections__short");
   document.addEventListener("click", function (e) {
      const t = e.target;
      t.closest(".spoller__title")
         ? de.classList.toggle("open")
         : de.classList.remove("open"),
         t.closest(".collections__short") &&
         ce.length &&
         (ce.forEach((e) => {
            e.classList.remove("_active");
         }),
            t.closest(".collections__short").classList.add("_active"),
            e.preventDefault());
   }),
      (window.FLS = !0),
      (function (e) {
